        ...
        title: Row(
          children: [
            Container(
              ...
              child: const Icon(LucideIcons.flag, color: AppColors.fitOrange, size: 20),
            ),
              ...
              builder: (context, state) {
                ...
                if (state is EventsLoaded) {
                  ...
                  return RefreshIndicator(
                    ...
                    onRefresh: () => context.read<EventsCubit>().loadEvents(filter: state.filter),
          ...
          child: ListView.separated(
            ...
            itemBuilder: (context, index) {
              ...
              return GestureDetector(
                onTap: () => context.read<EventsCubit>().loadEvents(filter: f['key']!),
                child: Container(
                  padding: const EdgeInsets.symmetric(horizontal: 16),
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              gradient: event.bannerUrl == null ? LinearGradient(
              ...
              children: [
                Positioned(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        Icon(meta['icon'] as IconData, size: 12, color: Colors.white),
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    const SizedBox(width: 12),
                    Icon(LucideIcons.users, size: 12, color: isDark ? AppColors.darkTextMuted : AppColors.lightTextMuted),
                    const SizedBox(width: 4),
                    Text(
