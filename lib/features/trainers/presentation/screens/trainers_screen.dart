        ...
        title: Row(
          children: [
            Container(
              ...
              child: const Icon(LucideIcons.dumbbell, color: AppColors.fitOrange, size: 20),
            ),
              ...
              children: [
                Expanded(
                  child: TextField(
                    ...
                    onSubmitted: (v) => context.read<TrainersCubit>().searchTrainers(v),
                    ...
                    decoration: InputDecoration(
                      ...
                      prefixIcon: Icon(LucideIcons.search, color: isDark ? AppColors.darkTextMuted : AppColors.lightTextMuted),
                ...
                Container(
                  ...
                  child: IconButton(
                    ...
                    onPressed: () => context.read<TrainersCubit>().searchTrainers(_searchController.text),
                  ),
                ),
              ],
            ),
...
class _TrainerCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final isDark = Theme.of(context).brightness == Brightness.dark;
    final initial = trainer.fullName.isNotEmpty ? trainer.fullName[0].toUpperCase() : 'T';
                    ...
                    Row(
                      children: [
                        if (trainer.experienceYears > 0) ...[
                          Icon(LucideIcons.award, size: 12, color: isDark ? AppColors.darkTextMuted : AppColors.lightTextMuted),
                        ...
                        const SizedBox(width: 12),
                        Icon(LucideIcons.check, size: 12, color: isDark ? AppColors.darkTextMuted : AppColors.lightTextMuted),
                        const SizedBox(width: 4),
                        Text(
...
class _BookingSheetState extends State<_BookingSheet> {
  ...
  final List<Map<String, dynamic>> _sessionTypes = [
    ...
    {'key': 'consultation', 'label': 'Consultation', 'icon': LucideIcons.messageCircle},
  ];
          ...
          builder: (context, state) {
            ...
            if (isSuccess) {
              return Column(
                ...
                children: [
                  ...
                  Text(
                    'Session requested!',
                    style: GoogleFonts.inter(fontSize: 16, fontWeight: FontWeight.bold, color: isDark ? AppColors.darkTextPrimary : AppColors.lightTextPrimary),
                  ),
            ...
            return Column(
              ...
              children: [
                ...
                Text('Session type', style: GoogleFonts.inter(fontSize: 12, fontWeight: FontWeight.bold, color: isDark ? AppColors.darkTextMuted : AppColors.lightTextMuted)),
                const SizedBox(height: 8),
                Row(
                      ...
                      child: GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            borderRadius: AppRadius.borderXl,
                            border: Border.all(
                              color: isSelected ? AppColors.fitOrange : (isDark ? AppColors.darkBorder : AppColors.lightBorder),
                              width: isSelected ? 2 : 1,
                            ),
                          ),
                          child: Column(
                            children: [
                              Icon(s['icon'] as IconData, size: 16, color: isSelected ? AppColors.fitOrange : (isDark ? AppColors.darkTextMuted : AppColors.lightTextMuted)),
                              const SizedBox(height: 4),
                              Text(
                                s['label'],
                                style: GoogleFonts.inter(
                  ...
                  children: [
                          ...
                          GestureDetector(
                            ...
                            child: Container(
                              ...
                              child: Text(
                                ...
                                style: GoogleFonts.inter(
                                  fontSize: 14,
                                  color: _selectedDate == null ? (isDark ? AppColors.darkTextMuted : AppColors.lightTextMuted) : (isDark ? AppColors.darkTextPrimary : AppColors.lightTextPrimary),
                                ),
                              ),
                            ),
                          ),
                    ...
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text('Time', style: GoogleFonts.inter(fontSize: 12, fontWeight: FontWeight.bold, color: isDark ? AppColors.darkTextMuted : AppColors.lightTextMuted)),
                          const SizedBox(height: 4),
                          GestureDetector(
                            onTap: () async {
                            ...
                            child: Container(
                              ...
                              child: Text(
                                ...
                                style: GoogleFonts.inter(
                                  fontSize: 14,
                                  color: _selectedTime == null ? (isDark ? AppColors.darkTextMuted : AppColors.lightTextMuted) : (isDark ? AppColors.darkTextPrimary : AppColors.lightTextPrimary),
                                ),
                              ),
                            ),
                          ),
                    ...
                    child: isLoading
                        ...
                        : Row(
                            ...
                            children: [
                              ...
                              const SizedBox(width: 8),
                              Text(
                                widget.trainer.sessionFee != null ? 'Request · ₹${widget.trainer.sessionFee!.toInt()}' : 'Request Session',
