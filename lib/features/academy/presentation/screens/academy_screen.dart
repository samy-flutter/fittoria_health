            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: const Color(0xFFEC4899).withValues(
                  alpha: 0.12,
                ), // Matching #EC4899 accent for patient
        ...
        builder: (context, state) {
          if (state is AcademyInitial ||
              (state is AcademyLoading &&
                  context.read<AcademyCubit>().state is! AcademyLoaded)) {
            return const Center(
                      ...
                      sliver: SliverGrid(
                        ...
                        delegate: SliverChildBuilderDelegate((context, index) {
                          ...
                          return GestureDetector(
                            onTap: () async {
                              final result = await context.push<AcademyVideo>(
                                RouteNames.patientAcademyDetails,
                                extra: v,
                              );
                              if (result != null && context.mounted) {
                                context.read<AcademyCubit>().updateVideoLocally(
                                  result,
                                );
                              }
                            },
